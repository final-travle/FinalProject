...
<body>
	...
	<div class="cont">
		<form method="post" action="membersearchId.do">
            ...
            <br>
            <div>이름 입력</div>
            <div style="font-size: 12px; color: darkgray;">아이디를 찾고자 하는 이름을 입력해 주세요.</div>
            <br>
            <input type="text" id="userName" name="name" style="width: 600px; height: 30px; border-radius: 8px; " placeholder="아이디를 입력해주세요">
            <br>     
            <div>이메일 입력</div>
            <div style="font-size: 12px; color: darkgray;">아이디를 찾고자 하는 이메일을 입력해 주세요.</div>
            <br>
