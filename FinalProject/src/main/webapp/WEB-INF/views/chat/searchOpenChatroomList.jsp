...
input#friendSearchResult_modal[type=checkbox]:checked ~ .friendSearchResult_modal {
  visibility: visible;
  -webkit-transform: scale(1, 1);
  -ms-transform: scale(1, 1);
  transform: scale(1, 1);
...
<div class="friendmodalheader">
 ...
 <tr>
 <td>
 	<h1 style="margin-top:30px; margin-left:10px;">오픈채팅</h1>
 	</td>
 	<td>
 	...
 	<form action="searchOpenChatroom.do" name="searchOpenChatroomForm">
	 	<input type="text" name="searchOpenChatroom" id="searchOpenChatroom"
	 	style="margin-left:10px;width:80%;height:23px;background:transparent;border:1px solid gray;outline:0;border-radius:8px;"
	 	placeholder="오픈채팅방 검색" autocomplete="off">
 	</form>
 	<br>
 	<hr>
  	  <br>
